/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-api/src/java/org/etudes/api/app/jforum/Topic.java $ 
 * $Id: Topic.java 7206 2014-01-22 01:32:00Z murthyt $ 
 *********************************************************************************** 
 * 
...
public interface Topic
{
	...
	/**
	 * Get the evaluation status of the gradable topic. Only facilitator has the access to it.
	 * 
	 * @return The evaluation status of the gradable topic.
	 */
	...
	/**
	 * Gets the user evaluation for gradable topic. If the user posts are not graded the id is not set.
	 * 
	 * @return	The user evaluation for gradable topic
	 */
