/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-api/src/java/org/etudes/api/app/jforum/JForumCategoryService.java $ 
 * $Id: JForumCategoryService.java 10723 2015-05-06 01:40:48Z murthyt $ 
 *********************************************************************************** 
 * 
...
public interface JForumCategoryService
{
	...
	/**
	 * Gets the user unread topics count
	 * 
	 * @param context	The context or course id
	 * 
	 * @param sakaiUserId	The sakai user id
	 * 
	 * @return The user unread topics count
	 */
