/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-api/src/java/org/etudes/api/app/jforum/dao/GradeDao.java $ 
 * $Id: GradeDao.java 7206 2014-01-22 01:32:00Z murthyt $ 
 *********************************************************************************** 
 * 
...
public interface GradeDao
{
	...
	/**
	 * Gets the user forum topics released evaluations count
	 * 
	 * @param forumId	Forum id
	 * 
	 * @param userId	User id'
	 * 
	 * @return	The user forum topics released evaluations count
	 */
	...
	/**
	 * Gets the user evaluations that are graded and released in the site
	 * 
	 * @param siteId	Site id
	 * 
	 * @param userId	User id
	 * 
	 * @return	The user evaluations that are graded and released in the site
	 */
