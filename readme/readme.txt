...
4. Build and Deploy Etudes Jforum
	a. Add Etudes Jforum version to master/pom.xml to "properties" element as below
			<!--Etudes-->
        	<etudes.jforum.version>2.9.10</etudes.jforum.version>
	...
	c. 	Run Maven Commands
		...
		Note : Make sure under tomcat(components, shared/lib, webapps) there are no other versions of jforum files than 2.9.10
