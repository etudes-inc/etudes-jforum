...
function previewMessage()
{
	...
	$.getScript('/ckeditor/ckeditor/plugins/ckeditor_wiris/core/WIRISplugins.js?viewer=image', function() {
	});
}

var fetchedBccUsers = false;
//Depends on jquery.js
function loadBccUsers()
{
	...
	document.getElementById('bccDetails1').style.display = "block";
	document.getElementById('bccDetails2').style.display = "block";
	
	var p = {};
	$.ajax({
		type:"POST",
		url:CONTEXTPATH + "/jforum" + SERVLET_EXTENSION + "?module=ajax&action=loadBccUsers",
		data:p,
		dataType:"script",
		global:false
	});
	
	fetchedBccUsers = true;
}