...
function savechanges(navto)
{
	try
	{
		...
		if (ele.value == "frmedit" || ele.value == "frmreorder" || ele.value == "frmcopy")
		{
			ele.value = "forumlist";
		}
		...
		else if (ele.value == "topics")
		{
			if (validateDates())
			{
				var ele1 = document.getElementById("saveTopics");
...
function defaultnav(navto)
{
	...
	else if (navto == 'topics')
	{
		document.location = "${contextPath}/adminTopics/forumList${extension}";
	}
	else if (navto == 'adminMenu')
	{
		document.location = "${contextPath}/admBase/adminMenu${extension}";
	}
	else if (navto == 'forumtopics')
	{
		var ele = document.getElementById("navid");
		...
		var navid = ele.value;
		document.location = "${contextPath}/adminTopics/topicsList/"+ navid+"${extension}";
	}
	else
	{
		document.location = "${contextPath}/adminForums/list${extension}";
