/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/JForumGBServiceImpl.java $ 
 * $Id: JForumGBServiceImpl.java 10626 2015-04-27 21:13:51Z murthyt $ 
 *********************************************************************************** 
 * 
...
public class JForumGBServiceImpl implements JForumGBService
{
			...
			String externalServiceDescription)
	{
		...
		try
		{
			if (gradebookService.isGradebookDefined(gradebookUid))
			{
				gradebookService.addExternalAssessment(gradebookUid, externalId, externalUrl, title, points, dueDate, externalServiceDescription);
				addSuccess = true;
			}
		}
		catch (GradebookNotFoundException e)
