/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/EvaluationImpl.java $ 
 * $Id: EvaluationImpl.java 7928 2014-05-07 19:10:15Z murthyt $ 
 *********************************************************************************** 
 * 
...
public class EvaluationImpl implements Evaluation
{
	...
	protected EvaluationReviewedStatus evaluationReviewedStatus;
	
	protected Date firstPostTime = null;
	 ...
	 * {@inheritDoc}
	 */
	public EvaluationReviewedStatus getEvaluationReviewedStatus()
	{
		...
		if (isReleased())
		{
			...
			else if (getEvaluatedDate() != null && getReviewedDate().before(getEvaluatedDate()))
			{
				reviewedStatus = Evaluation.EvaluationReviewedStatus.NOT_REVIEWED;;
			}
		}
		else
		{
			if (getTotalPosts() == 0)
			{
				reviewedStatus = Evaluation.EvaluationReviewedStatus.NO_POSTS;
			}
			else
			{
				reviewedStatus = Evaluation.EvaluationReviewedStatus.NOT_RELEASED;
			}
		}
