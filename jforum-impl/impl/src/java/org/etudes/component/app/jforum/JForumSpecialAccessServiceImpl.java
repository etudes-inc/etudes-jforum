/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/JForumSpecialAccessServiceImpl.java $ 
 * $Id: JForumSpecialAccessServiceImpl.java 6218 2013-10-30 18:09:49Z murthyt $ 
 *********************************************************************************** 
 * 
...
public class JForumSpecialAccessServiceImpl implements JForumSpecialAccessService
{
	...
	public List<SpecialAccess> getByTopic(int forumId, int topicId)
	{
		...
		List<SpecialAccess> specialAccessList = specialAccessDao.selectByTopic(forumId, topicId);
