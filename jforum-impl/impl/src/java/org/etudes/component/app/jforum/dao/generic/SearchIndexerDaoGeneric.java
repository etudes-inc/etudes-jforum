/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/dao/generic/SearchIndexerDaoGeneric.java $ 
 * $Id: SearchIndexerDaoGeneric.java 9164 2014-11-12 19:32:20Z murthyt $ 
 *********************************************************************************** 
 * 
...
public abstract class SearchIndexerDaoGeneric implements SearchIndexerDao
{
	...
	public void insertSearchWords(List<Post> posts)
	{
		...
		Pattern pattern = Pattern.compile("[\\.\\\\\\/~^&\\(\\)-_+=!@#$%\"\'\\[\\]\\{\\}?<:>,*�"
				+ "A�B�C�D�E�F�G�H�I�J�K�L�U�Z�]�^�a�b�e�f�i�j�m�n�q�r�u�v�y�z��������������������\n\r\t]");
		*/ 
		Pattern pattern = Pattern.compile("[\\.\\\\\\/~\\^\\&\\(\\)\\-_+=!@;#\\$%\"\'\\[\\]\\{\\}\\?<\\:>,\\*\n\r\t]"); 
