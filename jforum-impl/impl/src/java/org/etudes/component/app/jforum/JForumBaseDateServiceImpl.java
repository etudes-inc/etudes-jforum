/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/JForumBaseDateServiceImpl.java $ 
 * $Id: JForumBaseDateServiceImpl.java 6093 2013-10-03 18:27:49Z murthyt $ 
 *********************************************************************************** 
 * 
...
public class JForumBaseDateServiceImpl implements JForumBaseDateService
{
	...
	{
		Category category = jforumCategoryService.getCategory(catGrade.getCategoryId());
	...
	{
		Forum forum = jforumForumService.getForum(forumGrade.getForumId());
	...
	{
		Topic topic = jforumPostService.getTopic(topicGrade.getTopicId());
