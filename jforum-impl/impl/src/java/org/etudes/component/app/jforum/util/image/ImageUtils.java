/**********************************************************************************
 * $URL: https://source.etudes.org/svn/apps/jforum/tags/2.27/jforum-impl/impl/src/java/org/etudes/component/app/jforum/util/image/ImageUtils.java $ 
 * $Id: ImageUtils.java 7982 2014-05-16 00:10:32Z murthyt $ 
 *********************************************************************************** 
 * 
...
public class ImageUtils
{
	...
	public static void saveCompressedImage(BufferedImage image, String toFileName, int type) throws IOException
	{
		...
		catch (Exception e)
		{
			...
			{
				logger.warn("Error in saveCompressedImage.", e);
			}
		}
		finally
		{
